...
public class BossController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            UIManager.instance.bossÝsmi.text = bossName;
            UIManager.instance.bossÝsmi.gameObject.SetActive(true);
    ...
    public void TakeDamage(int damageToTake)
    {
        ...
        if(bossHealth <= 0)
        {
            ...
            UIManager.instance.bossÝsmi.text = bossName;
            UIManager.instance.bossÝsmi.gameObject.SetActive(false);
